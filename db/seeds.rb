...
Post.create!(user: user2,
             postable: Status.new(
               text: "Wow! Looks great! Have fun, Blessed",
             ), thread: post)

Post.create!(user: user1,
             postable: Status.new(text: "Ya! Ya! Ya! Are you in town?"), thread: post)

Post.create!(user: user2,
             postable: Status.new(text: "Yups! Let's explore the city!"), thread: post)

Post.create(user: user1,
            postable: Sight.new(place: place, activity_type: Sight::CHECKIN))
